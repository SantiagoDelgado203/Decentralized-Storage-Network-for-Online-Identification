...
If something goes wrong, do not return anithing. Use panic() instead.
*/
func init() {
...
func node_start(port string, custom_namespace string) (context.Context, host.Host, *dht.IpfsDHT, []string) {
	//create context
